/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f3e5e4109546b2fe259c1573d58be990)
// Runtime types generated with workerd@1.20260421.1 2026-04-07 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "PAYLOAD_PUBLIC_SERVER_URL" | "AUTH_EMAIL_FROM_ADDRESS" | "AUTH_EMAIL_FROM_NAME" | "AUTH_EMAIL_DEBUG" | "PAYLOAD_SECRET" | "GITHUB_URL">> {}
}

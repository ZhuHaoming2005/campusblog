/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6703a856107e205db0311226be0f88d3)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		AUTH_EMAIL_DEBUG: string;
		AUTH_EMAIL_DEBUG_DELIVER: string;
		AUTH_EMAIL_DEBUG_PRINT_URLS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "GITHUB_URL" | "NEXT_PUBLIC_SITE_URL" | "PAYLOAD_PUBLIC_SERVER_URL" | "AUTH_EMAIL_FROM_ADDRESS" | "AUTH_EMAIL_FROM_NAME" | "AUTH_EMAIL_DEBUG" | "AUTH_EMAIL_DEBUG_DELIVER" | "AUTH_EMAIL_DEBUG_PRINT_URLS">> {}
}

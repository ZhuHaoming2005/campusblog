/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ebfd76bfc8eab52a080a1e5d1c78c045)
// Runtime types generated with workerd@1.20260515.1 2026-04-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	GITHUB_URL: "https://github.com/ZhuHaoming2005/campusblog";
	NEXT_PUBLIC_SITE_URL: "https://campusblog-dev.zhuhaoming.workers.dev" | "https://campusblog.net";
	PAYLOAD_PUBLIC_SERVER_URL: "https://campusblog-dev.zhuhaoming.workers.dev" | "https://campusblog.net";
	AUTH_EMAIL_FROM_ADDRESS: "noreply@mail.campusblog.net";
	AUTH_EMAIL_FROM_NAME: "CampusBlog";
	AUTH_EMAIL_DEBUG: "true" | "false";
	...
	WORKER_SELF_REFERENCE: Fetcher /* campusblog-dev */ | Service<typeof import("./worker").default>;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		ASSETS: Fetcher;
		GITHUB_URL: "https://github.com/ZhuHaoming2005/campusblog";
		NEXT_PUBLIC_SITE_URL: "https://campusblog-dev.zhuhaoming.workers.dev";
		PAYLOAD_PUBLIC_SERVER_URL: "https://campusblog-dev.zhuhaoming.workers.dev";
		AUTH_EMAIL_FROM_ADDRESS: "noreply@mail.campusblog.net";
		AUTH_EMAIL_FROM_NAME: "CampusBlog";
		...
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./worker").DOQueueHandler>;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./worker").DOShardedTagCache>;
		WORKER_SELF_REFERENCE: Fetcher /* campusblog-dev */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_URL" | "NEXT_PUBLIC_SITE_URL" | "PAYLOAD_PUBLIC_SERVER_URL" | "AUTH_EMAIL_FROM_ADDRESS" | "AUTH_EMAIL_FROM_NAME" | "AUTH_EMAIL_DEBUG" | "PAYLOAD_SECRET">> {}
}
